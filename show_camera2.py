...
if __name__ == "__main__":
    ...
    parser.add_argument('--camera', type=str, default='/dev/video8',
                        help='摄像头设备路径 (默认: /dev/video6)')
